...
CREATE DATABASE IF NOT EXISTS `metrickit`;
...
DROP TABLE IF EXISTS `app_launch_time_first_draw`;
...
DROP TABLE IF EXISTS `app_launch_time_resume`;
...
DROP TABLE IF EXISTS `app_signpost`;
...
DROP TABLE IF EXISTS `app_signpost_interval`;
...
DROP TABLE IF EXISTS `app_signpost_histogram`;
